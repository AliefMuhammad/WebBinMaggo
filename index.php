               ...
               <div class="form">
                    <form action="" method="post"  name="form3">
                        <div class="form-group"> Nama :
                            <input type="" class="form-control" id="email" aria-describedby="emailHelp" placeholder="Nama" required name="email">
                        </div>
                        <div class="form-group"> No Telp :
                            <input type="" class="form-control" id="email" aria-describedby="emailHelp" placeholder="No Telepon" required name="email">
                        </div>
                        <div class="form-group"> Alamat :
                            <input type="" class="form-control" id="email" aria-describedby="emailHelp" placeholder="Alamat" required name="email">
                        </div>
                        <div class="form-group">
                            <label for="order">Apa Yang Dipesan:</label>
                                <select class="form-control" id="order" name="order" required name="email">
                        ...
                        <div class="form-group"> Berapa Yang Dipesan :
                            <input type="" class="form-control" id="email" aria-describedby="emailHelp" placeholder="Kuantitas" required name="email">
                        </div>
                    
                        <div class="form-submit d-flex justify-content-center">
                            <?php
                            echo '<a href="" class="link-sub" onclick="alert(\'Login Terlebih Dahulu!\');">
